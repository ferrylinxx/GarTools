      ...
      <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full text-center">
          <div className="bg-green-50 border-2 border-green-200 rounded-3xl p-8">
            ...
            <p className="text-green-700 font-semibold">Redirecting you to the app...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600 font-semibold">
            Join us and start processing today
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6 bg-white/80 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border-2 border-purple-100" onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600 font-semibold">
              ...
              <Link href="/auth/login" className="font-black text-purple-600 hover:text-purple-500 transition-colors">
                Sign in
              </Link>
            </p>
          </div>
